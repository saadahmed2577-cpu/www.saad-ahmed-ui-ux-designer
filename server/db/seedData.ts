...
export const SERVER_SEED_PROJECTS: Project[] = [
  {
...
export const SERVER_SEED_SKILLS: Skill[] = [
...
export const SERVER_SEED_EXPERIENCE: ExperienceItem[] = [
  {
    id: 'exp-1',
    company: 'Tech Minds Venture',
    role: 'UI/UX Designer',
    period: '2023 — Currently (2 Years)',
    description: 'During my two-year tenure at Tech Minds Venture, I worked in a dynamic role handling a wide range of design responsibilities, with a primary focus on UI/UX Design.',
    achievements: [
  ...
  },
  {
    ...
    period: '2022 — 2023',
    description: 'Delivered custom Photo Editing, Web Designing, Flyers, and Product Mock-Ups for global clients while maintaining high creative quality.',
    achievements: [
  ...
  },
  {
    ...
    period: '2019 — 2022',
    description: 'Successfully completed UI/UX Design Course at Arena Multimedia and CIT Diploma at INFO Channel Pakistan.',
    achievements: [
...
export const SERVER_SEED_TESTIMONIALS: Testimonial[] = [
  {
    id: 'test-1',
    name: 'Hamza Khan',
    role: 'Product Lead',
